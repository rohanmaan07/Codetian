        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-10">
          {projectsData.map((project, index) => (
            ...
            >
              ...
              <div className="p-6 md:absolute md:inset-0 md:bg-gradient-to-t md:from-black md:via-black/80 md:to-transparent md:opacity-0 group-hover:opacity-100 transition-opacity duration-500">
