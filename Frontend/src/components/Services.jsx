...
const servicesData = [
  {
    ...
    description: "We build high-performance, responsive websites from scratch, tailored perfectly to your business needs and brand identity."
  },
  {
    icon: (
      <svg xmlns="http://www.w3.org/2000/svg" className="h-10 w-10 text-purple-500" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={2}>
        <path strokeLinecap="round" strokeLinejoin="round" d="M4 5a1 1 0 011-1h14a1 1 0 011 1v2a1 1 0 01-1 1H5a1 1 0 01-1-1V5zM4 13a1 1 0 011-1h4a1 1 0 011 1v6a1 1 0 01-1 1H5a1 1 0 01-1-1v-6zM16 13a1 1 0 011-1h4a1 1 0 011 1v6a1 1 0 01-1 1h-4a1 1 0 01-1-1v-6z" />
      </svg>
    ),
    title: "Website Design",
    description: "We craft stunning, modern website designs that capture your brand's essence and engage your audience from the first click."
  },
  {
    icon: (
    ...
    description: "Breathe new life into your outdated website. We revamp your site with modern design, improved functionality, and a better user experience."
  },
  {
    icon: (
    ...
    title: "UI/UX Design",
    description: "We design intuitive, engaging, and beautiful user interfaces that provide an exceptional user experience and drive conversions."
  },
  {
    icon: (
    ...
    description: "We create powerful e-commerce platforms that drive sales, manage inventory, and provide a seamless shopping experience for your customers."
  },
  {
    icon: (
    ...
    description: "Integrate the power of Generative AI into your business with custom chatbots, automation tools, and intelligent data processing systems."
  },
  {
    icon: (
    ...
    description: "We provide ongoing support, security, and performance optimization to keep your site running smoothly and ranking well on search engines."
  }
];
