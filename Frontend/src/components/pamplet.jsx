...
const PamphletFront = () => (
  <div
    className="bg-black text-white p-6 rounded-lg shadow-2xl h-full flex flex-col justify-between border border-zinc-800"
    style={{ fontFamily: "'Inter', sans-serif" }}
  >
    {/* Header Section */}
    <div className="text-center mb-6">
      <h1 className="text-4xl font-extrabold tracking-widest uppercase text-red-600">
        Codetian
      </h1>
    ...
    <div className="flex flex-col items-center text-center my-4">
      <h2 className="text-4xl font-extrabold leading-tight">
        Turning Your <br /> Thoughts into{" "}
        <span className="text-red-600">Code</span>
      </h2>

      <p className="mt-3 text-sm text-gray-400 max-w-md">
        Welcome to Codetian — We create modern, beautiful, and
        high-performing websites that make a true impact.
      </p>
      ...
      <img
        src="/img.png"
        alt="Codetian Visual"
        className="w-[80%]  mt-6 rounded-lg "
      />
    </div>
    ...
    <div className="text-center mt-8">
      ...
      <p className="text-gray-500 text-xs mt-1">
        - Shri Krishna (Bhagavad Gita 2.47)
      </p>
      <p className="text-gray-400 text-xs mt-2">
        Meaning: "Focus on your actions, for your right lies only in the work
        itself, never in its rewards."
      </p>
    </div>
  </div>
);
...
const PamphletBack = () => (
  ...
  >
    <div>
      <h3 className="text-xl font-bold text-center mb-3 border-b-2 border-red-600 pb-2">
        About Us
      </h3>
      <p className="text-gray-400 text-center text-sm mb-4">
        We turn ideas into modern, beautiful, and high-performing websites with
        clean code and robust back-end solutions.
      </p>

      <div className="mt-6">
        <h3 className="text-xl font-bold text-center mb-4 border-b-2 border-red-600 pb-2">
          What We Offer
        </h3>
